StrongHelp WIMP Reference Manual
================================

This project contains the source files for the StrongHelp WIMP reference manual [hosted on riscos.info](http://www.riscos.info/downloads/stronghelp/manuals/).
